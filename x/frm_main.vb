...
Public Class frm_main
    ...
    Sub loadCreateRental(ByVal strRentalNo As String)
        ...
        End If
        If booleanNew Then
            f_CreateRental = New frmCreateRental
        End If
    ...
    Sub loadCheckOutRental(ByVal strRentalID As String)
        ...
        End If
        If booleanNew Then
            f_CheckOutRental = New frmRentalCheckOut
        End If
    ...
    Sub loadCheckINRental()
        ...
        End If
        If booleanNew Then
            f_CheckInRental = New frmRenCheckIn
        End If
    ...
    Sub loadfrmRentalView()
        ...
        End If
        If booleanNew Then
            f_CheckOutView = New frmRentalCheckOutVw
            'If Not frm2.Init() Then
            'frm2 = Nothing
            'Exit Sub
            'End If
    ...
    Sub loadfrmCreateSetItem(ByVal strSetBarcode)
        ...
        End If
        If booleanNew Then
            f_CreateSet = New frmSetAddRemove
            'If Not frm2.Init() Then
            'frm2 = Nothing
            'Exit Sub
            'End If
    ...
    Private Sub RENTALCHECKOUTToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RENTALCHECKOUTToolStripMenuItem.Click
        ...
        Dim dResult As New Windows.Forms.DialogResult
    ...
    Private Sub CREATEToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CREATEToolStripMenuItem.Click
        Dim a As New frmCreateRentalHDR
    ...
    Private Sub VIEWToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles VIEWToolStripMenuItem.Click
        'loadfrmRentalView()
        Dim a As New frmRentalCheckOutVw
    ...
    Private Sub VIEWEDITToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles VIEWEDITToolStripMenuItem.Click
        Dim a As New frmSetBarcodeView
        If a.ShowDialog() = Windows.Forms.DialogResult.OK Then
