...
" A.qty, f.brand_name, c.model_no, c.description, g.user_name" & _
" FROM [tbl_rental_line] a" & _
" left join tbl_rental_hdr b on a.rental_id = b.rental_id" & _
" left join tbl_part c on a.part_id = c.part_id" & _
" left join tbl_brand f on c.brand_id = f.brand_id" & _
...
" where a.rental_id = '" & strRentalID & "'"
            ...
            Dim A As New frm_rpt
            myReport.Load(Path + "\rpt\RentalSlip3.rpt")
