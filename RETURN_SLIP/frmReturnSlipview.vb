...
Imports System.Xml
Public Class frmReturnSlipview
...
" FROM [tbl_return_slip_hdr]"
            ...
            dgvRentalHDR.Columns(0).HeaderText = "RS NUMBER"
            dgvRentalHDR.Columns(1).HeaderText = "RETURNED TO"
            dgvRentalHDR.Columns(2).HeaderText = "DATE"
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Try
            If dgvRentalHDR.CurrentRow.Index > -1 Then
                ...
                a.txtReturnSlipNo.Text = (dgvRentalHDR.Item("rs_no", dgvRentalHDR.CurrentRow.Index).Value())
                a.Show()
                Me.Dispose()
            End If
        Catch ex As Exception
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If dgvRentalHDR.CurrentRow.Index > -1 Then
            Dim a As System.Windows.Forms.DialogResult
                Dim strRentalID As String = (dgvRentalHDR.Item("rs_no", dgvRentalHDR.CurrentRow.Index).Value())
                a = MessageBox.Show(String.Format("Are you sure you want to remove rs number: {0}?", dgvRentalHDR.Item("rs_no", dgvRentalHDR.CurrentRow.Index).Value()), _
                ...
                If a = DialogResult.Yes Then
                    If deleteRental(strRentalID) Then
                        MsgBox("Return Slip successfully remove!")
                        loadRentalHDR()
                    Else
                        MsgBox("Return Slip failed to remove!")
                    End If
                End If
            End If
        Catch ex As Exception
    ...
    Private Function deleteRental(ByVal strRentalID As String) As Boolean
        ...
        Try
            ...
            con.Open()
            sql = _
"DELETE FROM [tbl_return_slip_hdr]" & _
" WHERE [rs_no] = @rs_no"
            cmd = New SqlCommand(sql, con)
            cmd.Parameters.AddWithValue("@rs_no", strRentalID)
            If cmd.ExecuteNonQuery() > 0 Then
                Return True
            End If
            Return False
